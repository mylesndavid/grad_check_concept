...
<html lang="en">
  <head>
    ...
    <title>MBA: Health Care Del.</title>
  </head> ';
echoHeader("Business Administration Health Care Delivery Science Track");

echo '<br><h3>Students must complete all core courses and five electives.</h3>';
try {
  $sql = "
    SELECT C.course_name, C.course_id
      FROM requirements AS R, courses AS C
      WHERE R.course_id = C.course_id
      AND R.program_id = 2077
      AND R.course_type = 'C'
