...
<html lang="en">
  <head>
    ...
    <title>MBA: Part Time</title>
  </head> ';
echoHeader("Business Administration Part Time: For Working Professionals");

echo '<br><h3>Students must complete all core courses and four electives.</h3>';
try {
  $sql = "
    SELECT C.course_name, C.course_id
      FROM requirements AS R, courses AS C
      WHERE R.course_id = C.course_id
      AND R.program_id = 2088
      AND R.course_type = 'C'
